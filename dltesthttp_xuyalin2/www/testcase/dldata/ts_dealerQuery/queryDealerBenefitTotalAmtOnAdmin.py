...
class queryDealerBenefitTotalAmtOnAdmin(unittest.TestCase):
    ...
    #入参为空时查询到所有优惠券
    def test_queryDealerBenefitTotalAmtOnAdmin_nullPara(self):
        queryResult=self.dlservice.queryDealerBenefitTotalAmtOnAdmin()
    ...
    #入参完整时查询到所有优惠券
    def test_queryDealerBenefitTotalAmtOnAdmin_AllPara(self):
        ...
        queryResult=self.dlservice.queryDealerBenefitTotalAmtOnAdmin(couponEntityId=self.UsedDealerCouponInfo.couponEntityId,
...
def suite():
    ...
    #suite.addTest(queryBenefitTotalAmtOnAdmin("test_functions"))
    suite.addTest(queryDealerBenefitTotalAmtOnAdmin("test_queryDealerBenefitTotalAmtOnAdmin_AllPara"))
    suite.addTest(queryDealerBenefitTotalAmtOnAdmin("test_queryDealerBenefitTotalAmtOnAdmin_nullPara"))
    return suite
