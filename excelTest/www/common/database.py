...
portini = config['DATABASE']['port']
userini = config['DATABASE']['user']
passwdini = config['DATABASE']['passwd']
dbini = config['DATABASE']['db']
...
def create_engine(user=userini, password=passwdini, database=dbini, host=hostini, port=portini, **kw):
    """
